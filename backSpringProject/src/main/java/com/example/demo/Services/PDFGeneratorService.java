...
public class PDFGeneratorService {
    public void export(HttpServletResponse response, Abonnement abon) throws IOException {
        ...
        Paragraph paragraph3 = new Paragraph("\n Name and username : "+abon.getUser().getNom()+"\t"+abon.getUser().getPrenom(), fontParagraph);
        paragraph3.setAlignment(Paragraph.ALIGN_LEFT);
        
        Paragraph paragraph4 = new Paragraph("\n Activity name : "+abon.getActivity().getNom(), fontParagraph);
        paragraph4.setAlignment(Paragraph.ALIGN_LEFT);
        
        Paragraph paragraph5 = new Paragraph("\n Activity price : "+abon.getActivity().getPrix(), fontParagraph);
